...
export default function GuestDropoff(){
  ...
  return <div className="guest-page"><Card className="guest-card"><Logo/><PageHeader title="Guest Garage Drop-off" subtitle="Use this when a vehicle must be placed in garage and no mechanic is currently around." />
    <form className="form-grid" onSubmit={submit}>
      ...
      {form.imageUrl && <div className="vehicle-form-preview form-actions"><img src={form.imageUrl || '/vehicles/placeholder-car.png' || '/vehicles/placeholder-car.png'} onError={(e)=>{e.currentTarget.onerror=null;e.currentTarget.src='/vehicles/placeholder-car.png';}}/><section><h3>{form.model}</h3><p>{form.plate} • {form.cc}</p></section></div>}
