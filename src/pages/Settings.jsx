...
export default function Settings() {
  ...
  return (
    <div className="page">
      <PageHeader
        title="Settings"
        subtitle={`Manage users, roles and simple system rules. API: ${apiStatus}`}
      ...
      <div className="settings-grid">
        ...
        <Card>
          ...
          {[
            ...
            "Store all frontend changes in PostgreSQL through API",
          ].map((rule) => (
      ...
      {modal && (
        <Modal title="Add User" onClose={() => setModal(false)}>
          <div className="form-grid">
            ...
            <Field label="Email">
              <Input
                placeholder="name@vallepark.com"
                value={form.email}
            ...
            <Field label="Suggested Permission Template">
              ...
              >
                ...
                <option value="mechanic">
                  Mechanic: vehicles, assessments, garage ops
                </option>
                <option value="store">
                  Store: vehicles, assessments, inventory, transactions
                </option>
              </Select>
            </Field>
