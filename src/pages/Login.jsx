...
export default function Login(){
  ...
  function submit(e) {
    e.preventDefault();
    const res = login(selected.role, email, password);
    ...
    <div className="login-page">
      <div className="login-banner">
        <div className="login-banner-inner">
          <Logo />
          <h2>Garage & Spare Parts Management</h2>
        </div>
      </div>
        ...
        <section className="login-card">
          ...
          {!selected ? (
            ...
            <form onSubmit={submit} className="login-form">
              ...
              <p className="login-help">{selected.subtitle}</p>
              ...
              <small>
                Demo: {selected.email} / {selected.pass}
              </small>
            </form>
          )}
        </section>
