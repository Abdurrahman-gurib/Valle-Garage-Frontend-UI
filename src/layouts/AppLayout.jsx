...
export default function AppLayout() {
  ...
  return <div className="app-shell">
    <aside className="sidebar">
      <Logo />
      <div className="role-pill">{currentUser?.label}</div>
    ...
    <main className="main-area">
      <header className="topbar"><div><b>Internal Garage System</b><span>Simple workflow for employees</span></div><SearchBox/><div className="top-actions"><button className="notif" onClick={()=>navigate('/notifications')}>🔔 {notifications.length}</button><button className="user-chip">{currentUser?.label}</button></div></header>
      <Outlet />
    </main>
  </div>;
}
